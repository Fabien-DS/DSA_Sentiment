...
projet DSA Antoine Ly : classification des sentiments NLP
...
```bash
$ make bash
$ python dsa_sentiment/scripts/etl.py configs/examples/config_example.yml
```
...
```bash
python dsa_sentiment/scripts/evaluate.py configs/examples/config_example.yml
```
